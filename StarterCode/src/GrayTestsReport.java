...
public class GrayTestsReport {

    public GrayTestsReport() {
    }
        ...
        IntStream.rangeClosed(2, 16).forEach(numThreads -> {
            try {
                ...
                for (int i = 0; i < 3; i++) {
                    ...
                    filters.GrayFilterThreadPool("outputGrayFilterThreadPool.png", numThreads);
    ...
    private void runSequential(final String filePath) {
        ...
        filters.GrayScaleFilter("outputGrayFilter.png");

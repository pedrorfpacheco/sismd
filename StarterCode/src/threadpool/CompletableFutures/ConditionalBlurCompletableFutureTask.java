...
public class ConditionalBlurCompletableFutureTask implements Runnable {
    ...
    public ConditionalBlurCompletableFutureTask(Color[][] image, Color[][] tmp, int startColumn, int endColumn, int height, int matrixSize) {
        this.image = image;
        this.tmp = tmp;
